...
/**
 * The Without clause restricts the elements of a given source to only those elements 
 * that do not have elements in the related source that satisfy the suchThat condition.
