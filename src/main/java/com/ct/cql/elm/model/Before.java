...
/**
 * The Before operator is defined for Intervals, as well as DateTime and Time values.
 * 			
 ...
 * 
 * For the DateTime and Time overloads, the Before operator returns true if the first datetime is before the second datetime at the specified level of precision. As with all date/time calculations, comparisons are performed respecting the timezone offset.
 * 
