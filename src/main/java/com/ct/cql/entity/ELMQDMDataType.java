...
public enum ELMQDMDataType {
	...
	COMMUNICATION_FROM_PROVIDER_TO_PROVIDER("Communication: From Provider to Provider"),
	...
	DIAGNOSTIC_STUDY_PERFORMED("Diagnostic Study, Performed"),
	...
	ENCOUNTER_PERFORMED("Encounter, Performed"),
	...
	PATIENT_CHARACTERISTIC_PAYER("Patient Characteristic Payer"),
	PATIENT_CHARACTERISTIC_SEX("Patient Characteristic Sex"),	
	PATIENT_CHARACTERISTIC_ETHNICITY("Patient Characteristic Ethnicity"),
	PATIENT_CHARACTERISTIC_RACE("Patient Characteristic Race"),
	...
	INTERVENTION_ORDER("Intervention, Order"),
	...
	DIAGNOSTIC_STUDY_ORDER_NEGATED("Diagnostic Study, Order not done"),
	...
	INTERVENTION_ORDER_NEGATED("Intervention, Order not done"),
	...
	PHYSICAL_EXAM_PERFORMED_NEGATED("Physical Exam, Performed not done"),
	...
	COMMUNICATION_PERFORMED("Communication, Performed");
	
	//map of all String values (lower-cased) for reverse lookup
		private static Map<String, ELMQDMDataType> map = new HashMap<String, ELMQDMDataType>();
		static {
			for (ELMQDMDataType dataType : ELMQDMDataType.values()) {
		...
		private ELMQDMDataType(String value) {
		 ...
		 */
		public static ELMQDMDataType getNegatedDataType(ELMQDMDataType dataType) {
		 ...
		 */
		@JsonCreator
		public static ELMQDMDataType fromString(String value) {
			ELMQDMDataType result = map.get(value.toLowerCase());
			if (result == null) {
				throw new IllegalArgumentException("bad ELMQDMDataType: " + value);
			}
